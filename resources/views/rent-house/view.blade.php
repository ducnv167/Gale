                        ...
                        <div class="w3-card-4">
                            ...
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ID/Passport or Deposit Required\nNo smoking in shared spaces and common
                        ...
                        <form id="registerForm" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group1">
                                ...
                                <input type="text" name="name" id="nameInput"
                                    value="{{\Illuminate\Support\Facades\Auth::user()->name}}" minlength="3" readonly />
                            </div>
                            ...
                            <div class="form-group1">
                                ...
                                <input type="number" name="email" id="emailInput"
                                    value="{{\Illuminate\Support\Facades\Auth::user()->phone}}" placeholder="Your Email"
                                    readonly />
                            </div>
                            <div class="form-group1">
                                <label class="label-custom" for="email"><i class="zmdi zmdi-email"></i></label>
                                <input type="email" name="email" id="emailInput"
                                    value="{{\Illuminate\Support\Facades\Auth::user()->email}}" placeholder="Your Email"
                                    readonly />
                            </div>
                        </form>
                        @else
