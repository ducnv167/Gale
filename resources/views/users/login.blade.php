        ...
        <div class="container">
            <div class="signin-content">
                <div class="signin-image">
                    ...
                    <a href="{{route('users.register')}}" class="signup-image-link">Create an account</a>
                </div>

                <div class="signin-form">
                    <h2 class="form-title">Sign up</h2>
                    <form method="post" class="register-form" id="login-form" action="{{route('users.loginHandling')}}">
                        @csrf
