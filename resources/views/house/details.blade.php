                        ...
                        <div id="carouselExampleIndicators" class="carousel slide container" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                @foreach ($house->houseDetails as $key => $item)
                                    ...
                                    {{"active"}}
                                    @endif">
                                        <img src="{{ asset('storage/' . $item->filename) }}" class="d-block"
                        ...
                        <div class="col-md-4">
                            <div
                                ...
                                <form action="{{ route('rent', $house->id) }}">
                                    <h4><b>{{$house->price}}</b><small></small></h4>
                        ...
                        <div
                            ...
                            <form action="{{ route('rent', $house->id) }}">
                                <div class="form-group">
                                    ...
                                    @enderror
                                    Checkout: <input class="@error('checkout') is-invalid @enderror" id="endDate"
                                                     name="checkout" readonly required/>
                                    @error('checkout')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="pills-description-tab" data-toggle="pill"
                                       ...
                                       aria-expanded="true">Tính năng</a>
                                </li>
                                <li class="nav-item">
                                    ...
                                    @if(\Illuminate\Support\Facades\Auth::user()->id==$house->user_id)
                                        <li class="nav-item">
                                            <a class="btn btn-outline-success"
                                               href="{{route('users.history-show',$house->id)}}">Danh sách thuê</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="btn btn-outline-primary"
                                               href="{{route('house.edit',$house->id)}}">Sửa thông tin nhà</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="btn btn-outline-danger"
                                               href="{{route('house.delete',$house->id)}}" onclick="return confirm('Bạn có muốn xóa nhà này không?')">Xóa nhà</a>
                                        </li>
                                    @endif
                                @endif
                            </ul>
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-description" role="tabpanel"
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <ul class="features">
                                            <li class="check"><span class="fa fa-check-circle"></span>Địa chỉ:
                                                {{$house->address}}
                                            </li>
                                            <li class="check"><span class="fa fa-check-circle"></span>Phòng
                                                ngủ: {{$house->bedroom_amount}}</li>
                                            <li class="check"><span class="fa fa-check-circle"></span>Phòng
                                                tắm: {{$house->bathroom_amount}}</li>
                                            <li class="check"><span
                                    ...
                                    <div class="col-md-4">
                                        <ul class="features">
{{--                                            <li class="check"><span class="fa fa-check-circle"></span>Năm hoàn thiện:--}}
{{--                                                2019--}}
{{--                                            </li>--}}
                                            ...
                                            {{--                                            24/24--}}
                                            {{--                                        </li>--}}
                                            {{--                                        <li class="check"><span class="fa fa-check-circle"></span>Garage: </li>--}}
                                        </ul>
                                    </div>
                                </div>
                            </div>
